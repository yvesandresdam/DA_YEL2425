...
@NamedQueries(
        {
                @NamedQuery(
                        name="FlightEntity.getAllSources",
                        query="SELECT airport FROM AirportEntity airport"
                ),
                @NamedQuery(
                        name="FlightEntity.getCityWithCode",
                        query="SELECT city FROM CityEntity city WHERE city.code = :cityCode"
                )
        }
)
