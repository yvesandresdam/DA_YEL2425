...
public class TicketsController {
    ...
    public void createNewTicket(ActionEvent event) {
        ...
        if(formHasErrors){
            showWarningMessage("Error en el formulario", "Revise el log de errores");
        }
    ...
    private void validateFields(FlightEntity flight, String passport, String type){
        ...
        if (!availableSeats) {
            errorMessage = "No quedan asientos disponibles";
            formHasErrors = true;
            return;
        }
        ...
        if (duplicatedTicket) {
            errorMessage = "Ya existe un ticket para esa fecha";
            formHasErrors = true;
            return;
        }
    }
