...
public class TicketsControllerWEB {
    ...
    // Endpoint de tipo POST dedicado a cancelar un billete

    @GetMapping("/CancelTicket")
    public String cancelTicket(){
        return "cancel-ticket-form";
    }

    @PostMapping("/CancelTicket")
    public String cancelTicket(@ModelAttribute String passportNM, @ModelAttribute LocalDate date, Model model){
        ticketService.cancelTicket(passportNM,date);
        return "cancel-ticket-form";
    }

    // Endpoint anteriores al examen
